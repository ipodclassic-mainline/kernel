/*
 * Adapted from arch/arm/plat-s5l8702/time.c *
...
static void __init s5l8702_clocksource_init(void)
{
	u32 tick_rate;
	u16 val;
...
static int s5l8702_shutdown(struct clock_event_device *evt)
{
	timer_shutdown(evt);
...
static int s5l8702_set_oneshot(struct clock_event_device *evt)
{
	u16 val;
...
static int s5l8702_set_periodic(struct clock_event_device *evt)
{
	u32 period;
	u16 val;
...
static struct clock_event_device clkevt = {
	...
	.set_state_shutdown = s5l8702_shutdown,
	.set_state_periodic = s5l8702_set_periodic,
	.set_state_oneshot = s5l8702_set_oneshot,
	.tick_resume = s5l8702_shutdown,
...
static void __init s5l8702_clockevent_init(int irq)
{
	u32 tick_rate;
	...
	if (request_irq(irq, s5l8702_timer_interrupt, IRQF_TIMER, "timer", NULL))
		pr_err("Failed to request irq %d (timer)\n", irq);
}

static const struct of_device_id timer_of_match[] __initconst = {
	{ .compatible = "st,s5l8702-timer", },
	{ },
};

void __init s5l8702_setup_of_timer(void)
{
	...
	s5l8702_clockevent_init(irq);
	s5l8702_clocksource_init();
